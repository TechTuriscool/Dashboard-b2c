export class customUserScore extends HTMLElement {
        ...
        if (oldValue !== newValue) {
            switch (attribute) {
                case "user-id":
                    ...
                    this.showLoader(); // Mostrar el loader mientras se carga la data
                    this.fetchProgress();
                    break;
            }
        }
    ...
    calculateFilterData() {
        ...
        average = average / totalCoursesCompleted;
    ...
    connectedCallback() {
        this.render("Cargando...", "Cargando...", "Cargando...");
    }

    updateUI() {
        this.render(this.filterData.totalTime , `${this.filterData.totalUnitsCompleted} / ${this.filterData.totalUnits}`, `${this.filterData.average} / 10`);
    }

    render(totalTime, totalUnitsCompleted, average) {
        this.innerHTML = `
        <div class="userProgress">
            ...
            <div class="progress">
                <div id="totalTime">
                    ...
                    <p class="parrafoSuperiorProgress">${totalTime}</p>
                    <p class="parrafoInferiorProgress">MI TIEMPO</p>
                </div>
